                ...
                <div class="block-area" id="horizontal">
                    ...
                    <form class="form-horizontal form-validation-9"" role="form" method="post" action="<?php echo url($actionName); ?>">
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="data[role_name]" class="form-control input-sm validate[required,minSize[2],maxSize[20]]" id="role_name" placeholder="请输入角色名称" value="<?php echo isset($editData['role_name']) ? $editData['role_name'] : ''; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="role_desc" class="col-md-2 control-label">角色描述</label>
                            <div class="col-md-10">
                                <textarea class="form-control auto-size input-sm validate[minSize[2],maxSize[200]]" id="role_desc" name="data[role_desc]" placeholder="请输入角色描述"><?php echo isset($editData['role_desc']) ? $editData['role_desc'] : ''; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
