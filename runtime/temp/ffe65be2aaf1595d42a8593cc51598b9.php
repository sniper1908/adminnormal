										...
										<table class="table table-striped table-hover">
											...
											<tbody>
												...
												<tr>
													...
													<td><?php if($value['f_type'] == 1): ?><img src="../<?php echo $value['f_logo']; ?>" width="88" height="31"><?php else: ?>--<?php endif; ?></td>
													<td><?php if($value['is_show'] == 1): ?>是<?php else: ?>否<?php endif; ?></td>
													<td><?php echo $value['sort_order']; ?></td>
													<td><?php if($value['f_type'] == 1): ?>图片<?php else: ?>文字<?php endif; ?></td>
													<td><?php echo $value['hit_count']; ?></td>
