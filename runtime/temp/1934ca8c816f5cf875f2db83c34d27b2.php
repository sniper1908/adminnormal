										...
										<table class="table table-striped table-hover">
											...
											<tbody>
												...
												<tr>
													...
													<td><a href="<?php echo url('permission?id='.$value["id"]); ?>"><span class="label label-success">分配权限</span></a>  <a href="<?php echo url('edit?id='.$value["id"]); ?>"><span class="label label-primary">编辑</span></a>  <a href="<?php echo url('del?id='.$value["id"]); ?>"><span class="label label-danger">删除</span></a></td>
												</tr>
