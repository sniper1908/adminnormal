								...
								function getArticleCatTempList($list){
									if($list) {
										...
										$str = '';
											...
											$str .= '<td>';
											$str .= '<a href="'.url('article/index?cat_id='.$cat["id"]).'"><span class="label label-primary">查看文章</span></a>  ';
