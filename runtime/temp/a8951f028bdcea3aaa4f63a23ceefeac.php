<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:82:"D:\phpStudy\WWW\adminnormal\public/../application/admin\view\nav_manage\index.html";i:1541577499;s:69:"D:\phpStudy\WWW\adminnormal\application\admin\view\layout\layout.html";i:1537319633;s:69:"D:\phpStudy\WWW\adminnormal\application\admin\view\layout\header.html";i:1553479369;s:66:"D:\phpStudy\WWW\adminnormal\application\admin\view\layout\nav.html";i:1540169717;s:73:"D:\phpStudy\WWW\adminnormal\application\admin\view\layout\breadcrumb.html";i:1537322472;s:69:"D:\phpStudy\WWW\adminnormal\application\admin\view\layout\footer.html";i:1545879240;}*/ ?>
							...
							<div class="panel">
								<div class="panel-heading">
									<p class="panel-title pull-right">
										<a href="<?php echo url('add'); ?>"><span class="label label-primary">添加数据</span></a>
									</p>
								...
								<div class="panel-body">
									<form action="<?php echo url('delall'); ?>" method="post">
										<table class="table table-striped table-hover">
											...
											<tbody>
												<?php if(is_array($top) || $top instanceof \think\Collection || $top instanceof \think\Paginator): $i = 0; $__LIST__ = $top;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?>
												<tr>
													...
													<td><?php if($value['if_show'] == 1): ?>是<?php else: ?>否<?php endif; ?></td>
													<td><?php if($value['open_new'] == 1): ?>是<?php else: ?>否<?php endif; ?></td>
													<td>头部</td>
