										...
										<table class="table table-striped table-hover">
											...
											<tbody>
												...
												<tr>
													...
													<td><?php echo $value['admin_ip']; ?></td>
													<td><?php echo date('m-d H:i',$value['last_time']); ?></td>
