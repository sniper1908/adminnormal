										...
										<table class="table table-striped table-hover">
											...
											<tbody>
												...
												<tr>
													...
													<td><?php echo $value['permission_name_code']; ?></td>
													<td><?php echo $value['parent_name']; ?></td>
													<td><a href="<?php echo url('edit?id='.$value["id"]); ?>?page=<?php echo $page; ?>"><span class="label label-primary">编辑</span></a>  <a href="<?php echo url('del?id='.$value["id"]); ?>"><span class="label label-danger">删除</span></a></td>
												</tr>
												<?php if(!(empty($value['children']) || (($value['children'] instanceof \think\Collection || $value['children'] instanceof \think\Paginator ) && $value['children']->isEmpty()))): if(is_array($value['children']) || $value['children'] instanceof \think\Collection || $value['children'] instanceof \think\Paginator): $i = 0; $__LIST__ = $value['children'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
												<tr>
													...
													<td><?php echo $val['permission_name_code']; ?></td>
													<td><?php echo $val['parent_name']; ?></td>
													<td><a href="<?php echo url('edit?id='.$val["id"]); ?>?page=<?php echo $page; ?>"><span class="label label-primary">编辑</span></a>  <a href="<?php echo url('del?id='.$val["id"]); ?>"><span class="label label-danger">删除</span></a></td>
												</tr>
